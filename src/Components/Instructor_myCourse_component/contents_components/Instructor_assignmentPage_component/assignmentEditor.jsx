...
function AssessmentEditor() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`w-full max-w-4xl mx-auto rounded-xl shadow-md p-4 sm:p-6 md:p-8 ${
          ...
          <div className='space-y-4 sm:space-y-6'>
            <div>
              ...
              <input
                ...
                className={`w-full border outline-none p-2 sm:p-3 rounded focus:ring-2 focus:ring-[#49BBBD] focus:border-transparent transition text-sm sm:text-base ${
                  theme === 'dark'
            ...
            <div>
              ...
              <div className='space-y-4 sm:space-y-6'>
                {assessment.questions.map((question, qIndex) => (
                  <div
                    key={qIndex}
                    className={`p-3 sm:p-4 border rounded-md space-y-3 sm:space-y-4 ${
                    ...
                    <div>
                      ...
                      {question.options.map((option, oIndex) => (
                        ...
                        >
                          <input
                            ...
                            className={`w-full flex-1 border outline-none p-2 sm:p-2 rounded focus:ring-2 focus:ring-[#49BBBD] focus:border-transparent transition text-sm sm:text-base ${
                              theme === 'dark'
                                ? 'border-gray-600 bg-gray-800 text-white'
                                : 'border-gray-300 bg-white text-black'
                            }`}
                          ...
                          <div className='flex flex-row justify-between w-full px-2'>
                            <label className='flex items-center'>
                              <input
                                ...
                                className={`mr-2 sm:mr-2 h-4 w-4 text-[#49BBBD] focus:ring-[#49BBBD] rounded ${
                      ...
                      <button
                        ...
                        className={`mt-2 text-sm sm:text-base ${
                          theme === 'dark' ? 'text-teal-400 hover:text-teal-300' : 'text-[#49BBBD] hover:text-[#3AA8AA]'
                        }`}
                        title="Add Option"
                      >
                        + Add Option
                ...
                <button
                  onClick={addQuestion}
                  className={`mt-4 px-3 sm:px-4 py-1.5 sm:py-2 text-white font-semibold rounded-md transition duration-300 text-sm sm:text-base ${
                    theme === 'dark'
            ...
            <div className='flex flex-wrap justify-end mt-6 sm:mt-8 gap-2 sm:gap-3'>
              <button
                ...
                className={`px-4 sm:px-6 py-1.5 sm:py-2 font-semibold rounded-md transition duration-300 text-sm sm:text-base ${
                  theme === 'dark'
