  ...
  return (
    <ErrorBoundary theme={theme}>
      ...
      >
        ...
        />
        <h1
          className={`!text-[2rem] md:text-3xl font-bold mb-3 sm:mb-4 text-left ${
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 pl-1 sm:pl-2">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 mt-3 sm:mt-0">
            <button
              ...
              className={`py-1.5 px-3 sm:px-4 rounded text-sm sm:text-base transition cursor-pointer ${
                theme === "dark"
            ...
            <select
              ...
              className={`py-1.5 px-3 sm:px-4 rounded outline-none border-none text-sm sm:text-base transition cursor-pointer ${
                theme === "dark"
                  ? "bg-[#2F5D6B] text-white hover:bg-[#4A7A8A]"
                  : "bg-[#49BBBD] text-white hover:bg-[#3a9a9b]"
              }`}
            >
        ...
        {showAssignments ? (
          ...
          <div
            className={`w-full relative mx-auto rounded-lg p-4 sm:p-6 bg-transparent ${
              theme === "dark" ? "bg-gray-800" : "bg-transparent"
            }`}
          >
            <button
              onClick={() => setShowCurriculum(true)}
              className={`py-1.5 px-3 sm:px-4 rounded absolute top-2 right-2 sm:top-3 sm:right-3 text-sm sm:text-base transition cursor-pointer ${
                theme === "dark"
                  ? "bg-[#2F5D6B] text-white hover:bg-[#4A7A8A]"
                  : "bg-[#49BBBD] text-white hover:bg-[#3a9a9b]"
              }`}
          ...
          <div
            className={`max-w-full sm:max-w-5xl md:max-w-6xl lg:max-w-7xl mx-auto rounded-lg shadow-md overflow-hidden ${
              theme === "dark" ? "bg-gray-800" : "bg-white"
            }`}
          >
            <div
              className={`relative flex flex-col lg:flex-row h-[calc(100vh-10rem)] sm:h-[calc(100vh-12rem)] border-2 rounded-[11px] ${
                theme === "dark" ? "border-gray-600" : "border-gray-200"
              }`}
            >
              <div
                className={`lg:hidden flex justify-between items-center p-3 sm:p-4 z-20 rounded-[11px] ${
                  theme === "dark" ? "bg-gray-800" : "bg-white"
                }`}
              >
                <button
              ...
              <div
                className={`fixed inset-y-0 left-0 z-30 transform w-64 sm:w-72 shadow-lg transition-transform rounded-[11px] duration-300 ease-in-out ${
        ...
        {isTitleModalOpen && (
          ...
          >
            <div
              className={`rounded-lg shadow-lg w-[90%] max-w-xs sm:max-w-sm md:max-w-md p-4 sm:p-6 ${
            ...
            >
              ...
              <input
                className={`w-full border rounded mb-3 sm:mb-4 text-sm sm:text-base focus:ring-2 focus:ring-[#49BBBD] focus:border-transparent transition outline-none ${
                  theme === "dark"
              ...
              <div className="flex justify-end gap-2 sm:gap-3">
                <button
                  ...
                  className={`py-1.5 px-3 sm:px-4 rounded text-sm sm:text-base transition cursor-pointer ${
                    theme === "dark"
                      ? "bg-[#2F5D6B] text-white hover:bg-[#4A7A8A] disabled:bg-gray-600 disabled:cursor-not-allowed"
                      : "bg-[#49BBBD] text-white hover:bg-[#3a9a9b] disabled:bg-gray-400 disabled:cursor-not-allowed"
                  }`}
                >
                  Update
                </button>
