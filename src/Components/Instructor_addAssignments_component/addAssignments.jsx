...
function AddAssignments({ courseId }) {
  ...
  return (
    <div
      className={`min-h-screen w-full flex items-center justify-center px-3 py-4 sm:px-4 sm:py-6 md:px-6 md:py-8 ${
    ...
    >
      ...
      />
      <div
        className={`w-full max-w-4xl rounded-xl shadow-md p-4 sm:p-6 md:p-8 ${
          theme === "dark" ? "bg-gray-800" : "bg-white"
        }`}
      >
        <h1
          className={`!text-[1.5rem] sm:text-2xl md:text-3xl font-bold text-center mb-4 sm:mb-6 ${
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 text-sm sm:text-base">
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-md px-3 py-2 focus:ring-2 focus:ring-cyan-500 outline-none text-sm sm:text-base ${
                  theme === "dark"
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full border rounded-md px-3 py-2 focus:ring-2 focus:ring-cyan-500 outline-none resize-none text-sm sm:text-base ${
                theme === "dark"
                  ? "border-gray-600 bg-gray-700 text-white"
                  : "border-gray-300 bg-white text-black"
              }`}
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            <div className="flex-1">
              ...
              <DatePicker
                ...
                minDate={new Date()}
                required
                popperClassName={theme === "dark" ? "dark-datepicker" : ""}
              />
            </div>
            <div className="flex-1">
              <label
          ...
          {questions.map((q, qIndex) => (
            <div
              key={qIndex}
              className={`p-3 sm:p-4 border rounded-md space-y-4 ${
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`font-medium px-3 sm:px-4 py-1.5 sm:py-2 rounded-md text-sm sm:text-base transition ${
                questions.length >= 5
                  ? theme === "dark"
          ...
          <div>
            <button
              type="submit"
              className={`w-full text-white font-semibold py-2 sm:py-2.5 rounded-md transition duration-300 text-sm sm:text-base ${
                theme === "dark"
